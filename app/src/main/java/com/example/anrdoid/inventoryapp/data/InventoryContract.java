package com.example.anrdoid.inventoryapp.data;
...
public class InventoryContract {
    ...
    public static final String CONTENT_AUTHORITY =  "com.example.anrdoid.inventoryapp";
    ...
    public final static class InventoryEntry implements BaseColumns {
        ...
        public final static int SUPPLIER_WISH = 3;

        public static boolean isValidSupplierName(int suppliername) {
            if (suppliername == SUPPLIER_UNKNOWN || suppliername == SUPPLIER_AMAZON || suppliername == SUPPLIER_EBAY || suppliername == SUPPLIER_WISH) {
                return true;
            }
            return false;
        }
