package com.example.anrdoid.inventoryapp;
...
import com.example.anrdoid.inventoryapp.data.InventoryContract.InventoryEntry;
        ...
        mProductSupplieNameSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!TextUtils.isEmpty(selection)) {
                    ...
                    } else if (selection.equals(getString(R.string.supplier_wish))) {
                        mSupplieName = InventoryEntry.SUPPLIER_WISH;
                    } else {
        ...
        if (cursor.moveToFirst()) {
            ...
            switch (currentSupplierName) {
                ...
                case InventoryEntry.SUPPLIER_EBAY:
                    ...
                    break;
                case InventoryEntry.SUPPLIER_WISH:
